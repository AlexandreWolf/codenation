...
const Filters = ({ contacts, setList }) => {
  ...
  const sortByTarget = (list, target) =>
  ...
  const handleClick = (textContent) =>
    setContext(context !== textContent ? textContent : "");
  ...
  const handleSortList = ({ target: { classList } }, targetContext) =>
    setList(reverseList(classList, sortList(targetContext)));

  const reverseList = (classList, list) =>
    !classList.contains("is-selected") ? list : list.reverse();
    ...
    <div className="container" data-testid="filters">
      <section className="filters">
        ...
        <button
          ...
          onClick={(e) => {
            handleClick("name");
            handleSortList(e, "name");
          }}
        >
          Nome{" "}
          <i
            className={`fas ${
              context === "name" ? "fa-sort-up" : "fa-sort-down"
            }`}
          />
        </button>
        ...
        <button
          ...
          onClick={(e) => {
            handleClick("country");
            handleSortList(e, "country");
          }}
        >
          País{" "}
          <i
            className={`fas ${
              context === "country" ? "fa-sort-up" : "fa-sort-down"
            }`}
          />
        </button>
        ...
        <button
          ...
          onClick={(e) => {
            handleClick("company");
            handleSortList(e, "company");
          }}
        >
          Empresa{" "}
          <i
            className={`fas ${
              context === "company" ? "fa-sort-up" : "fa-sort-down"
            }`}
          />
        </button>
        ...
        <button
          className={`filters__item ${
            context === "department" && "is-selected"
          }`}
          onClick={(e) => {
            handleClick("department");
            handleSortList(e, "department");
          }}
        >
          Departamento{" "}
          <i
            className={`fas ${
              context === "department" ? "fa-sort-up" : "fa-sort-down"
            }`}
          />
        </button>
        ...
        <button
          ...
          onClick={(e) => {
            handleClick("date");
            handleSortList(e, "date");
          }}
        >
          Data de admissão{" "}
          <i
            className={`fas ${
              context === "date" ? "fa-sort-up" : "fa-sort-down"
            }`}
          />
        </button>
      </section>
